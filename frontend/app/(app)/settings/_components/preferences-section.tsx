                ...
                <div className="lg:col-span-2 space-y-8 max-w-2xl">
                    ...
                    <div className="space-y-6 max-w-md">
                        ...
                        <div className="flex items-start justify-between">
                            ...
                            <input type="checkbox" id="email-digest" className="w-5 h-5 rounded border-gray-300 text-[#1C7C54] focus:ring-[#1C7C54] mt-1" defaultChecked />
                        </div>
                        ...
                        <div className="flex items-start justify-between">
                            ...
                            <input type="checkbox" id="new-comments" className="w-5 h-5 rounded border-gray-300 text-[#1C7C54] focus:ring-[#1C7C54] mt-1" defaultChecked />
                        </div>
                    </div>

                    <div className="flex justify-end pt-4">
                        <Button className="bg-[#1C7C54] hover:bg-[#1B512D] text-white rounded-lg px-6">
                            Save Preferences
                        </Button>
                    </div>
                </div>
