      ...
      <div className="flex items-center gap-2 relative z-10">
        ...
        >
          ...
          <div className="flex items-center gap-0.5 ml-1">
            <kbd className="text-[9px] bg-white border border-gray-200 rounded px-1 py-px text-gray-400 font-mono">
              ⌘
            </kbd>
            <kbd className="text-[9px] bg-white border border-gray-200 rounded px-1 py-px text-gray-400 font-mono">
              K
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent
            align="end"
            className="w-44 mt-1.5 rounded-xl border-black/[0.06] shadow-lg"
          >
            {user?.name && (
              <>
                <div className="px-3 py-2">
                  <p className="font-ui text-[13px] font-medium text-gray-900">
                    {user.name}
                  </p>
                  <p className="font-ui text-[11px] text-gray-500">
                    {user.email}
                  </p>
                </div>
            ...
            <DropdownMenuItem
              className="font-ui text-[12px] cursor-pointer rounded-lg m-1"
              asChild
            >
            ...
            <DropdownMenuSeparator className="bg-black/[0.06]" />
            <DropdownMenuItem
              className="font-ui text-[12px] text-destructive focus:text-destructive focus:bg-destructive/10 cursor-pointer rounded-lg m-1"
